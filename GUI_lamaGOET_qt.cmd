...
:custom_python
"%LAMAGOET_QT_PYTHON%" "%SCRIPT_DIR%GUI_lamaGOET_qt.py" --mode cluster %*
exit /b %errorlevel%

:private_python
"%SCRIPT_DIR%.venv-qt\Scripts\python.exe" "%SCRIPT_DIR%GUI_lamaGOET_qt.py" --mode cluster %*
exit /b %errorlevel%

:python_launcher
py -3 "%SCRIPT_DIR%GUI_lamaGOET_qt.py" --mode cluster %*
exit /b %errorlevel%

:system_python
python "%SCRIPT_DIR%GUI_lamaGOET_qt.py" --mode cluster %*
exit /b %errorlevel%
