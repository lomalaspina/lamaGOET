...
#
#    gnuplot -persist 'stdout.Delta_F_vs_stl.gnuplot'
#
...
set yrange [-0.200000E+01:0.100000E+01]

# Plot
plot 'stdout.Delta_F_vs_stl' using 1:2 \
        with points pt 7 ps 0.3 lc rgb 'dark-violet', \
     'stdout.Delta_F_vs_stl.labels' using 1:2:($5-$1):($6-$2) \
        with vectors nohead lw 1 lc rgb 'gray50', \
     'stdout.Delta_F_vs_stl.labels' using 3:4:7 \
        with labels center font ',8' tc rgb 'red'

# PDF output
# Uncomment, or do it from the Qt window
# set terminal pdfcairo size 5,5
# set output 'stdout.Delta_F_vs_stl.gnuplot.pdf'
# replot
